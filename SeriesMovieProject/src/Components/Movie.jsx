...
function Movie({ movie }) {
    return (
        <div className="border border-border p-1 hover:scale-95 transitions relative overflow-hidden rounded-lg">
            <Link to={`/api/moviesinfo/${movie.id}`} className='w-full'>
                <img
